      ...
      <Fragment>
        ...
        <main>
          ...
          <div className="col-md-3 profile-sidebar" >
            ...
            <img src="https://365webresources.com/wp-content/uploads/2016/09/FREE-PROFILE-AVATARS.png" className="img-thumbnail rounded-circle profile-usertitle-image"  alt="avatar"/>
            ...
            <div className="profile-userbuttons">
                  <button type="button" className="btn btn-success btn-sm">Wyloguj</button>
                  <button type="button" className="btn btn-danger btn-sm">Reset hasła</button>
            </div>

            <ul className="list-group list-group-flush profile-userlist">
            
              <li  className="list-group-item">
                <svg className="bi bi-phone" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="list-group-item">
                <svg className="bi bi-envelope" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="list-group-item">
                <svg className="bi bi-briefcase" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="list-group-item">
              <svg className="bi bi-chat" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
