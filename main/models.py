...
class Group(models.Model):
    profile = models.ForeignKey(
        CompanyProfile, related_name="group", on_delete=models.CASCADE)
...
class Profile(models.Model):
    ...
    telephone_number = models.CharField('Numer telefonu', max_length=50)
    first_name = models.CharField('imię', max_length=100)
    last_name = models.CharField('Nazwisko', max_length=250)
    company_name = models.CharField('Firma', max_length=250)
    skype_number = models.CharField('Numer skype', max_length=50)
